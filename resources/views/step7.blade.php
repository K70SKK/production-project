<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Step 7: Final notes') }}
        </h2>
    </x-slot>

    <textarea class="w-full h-40 border border-gray-300 rounded-md p-2 mt-4 focus:outline-none focus:ring focus:border-blue-300" placeholder="Add any notes which you think be be relvant to the case " rows="4" cols="50"></textarea>
 ...
 <div class="container mx-auto flex justify-start mt-4">
    ...
    <div class="container mx-auto flex justify-end mt-4">
        <a href="{{ route('end') }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Next</a>
    </div>
