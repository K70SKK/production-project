                ...
                <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
                    <form method="POST" action="{{ route('step1.store') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="first_responder_name" id="first_responder_name" autocomplete="given-name" value="<First Responder Name>" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" required>
                        </div>

                        <div class="mb-4">
                            <label for="company_data" class="block text-sm font-medium text-gray-700">Company Data</label>
                            <input type="text" name="company_data" id="company_data" autocomplete="organization" value="<Company Name>" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" required>
                        </div>
